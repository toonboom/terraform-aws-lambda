...
output "lambda_function_arn" {
  ...
  value       = var.ignore_environment_variables ? (element(concat(aws_lambda_function.ignore_environment_variables.*.arn, [""]), 0)) : (element(concat(aws_lambda_function.default.*.arn, [""]), 0))
}

output "lambda_function_invoke_arn" {
  description = "The Invoke ARN of the Lambda Function"
  value       = var.ignore_environment_variables ? element(concat(aws_lambda_function.ignore_environment_variables.*.invoke_arn, [""]), 0) : element(concat(aws_lambda_function.default.*.invoke_arn, [""]), 0)
}

output "lambda_function_name" {
  description = "The name of the Lambda Function"
  value       = var.ignore_environment_variables ? element(concat(aws_lambda_function.ignore_environment_variables.*.function_name, [""]), 0) : element(concat(aws_lambda_function.default.*.function_name, [""]), 0)
}

output "lambda_function_qualified_arn" {
  description = "The ARN identifying your Lambda Function Version"
  value       = var.ignore_environment_variables ? element(concat(aws_lambda_function.ignore_environment_variables.*.qualified_arn, [""]), 0) : element(concat(aws_lambda_function.default.*.qualified_arn, [""]), 0)
}

output "lambda_function_version" {
  description = "Latest published version of Lambda Function"
  value       = var.ignore_environment_variables ? element(concat(aws_lambda_function.ignore_environment_variables.*.version, [""]), 0) : element(concat(aws_lambda_function.default.*.version, [""]), 0)
}

output "lambda_function_last_modified" {
  description = "The date Lambda Function resource was last modified"
  value       = var.ignore_environment_variables ? element(concat(aws_lambda_function.ignore_environment_variables.*.last_modified, [""]), 0) : element(concat(aws_lambda_function.default.*.last_modified, [""]), 0)
}

output "lambda_function_kms_key_arn" {
  description = "The ARN for the KMS encryption key of Lambda Function"
  value       = var.ignore_environment_variables ? element(concat(aws_lambda_function.ignore_environment_variables.*.kms_key_arn, [""]), 0) : element(concat(aws_lambda_function.default.*.kms_key_arn, [""]), 0)
}

output "lambda_function_source_code_hash" {
  description = "Base64-encoded representation of raw SHA-256 sum of the zip file"
  value       = var.ignore_environment_variables ? element(concat(aws_lambda_function.ignore_environment_variables.*.source_code_hash, [""]), 0) : element(concat(aws_lambda_function.default.*.source_code_hash, [""]), 0)
}

output "lambda_function_source_code_size" {
  description = "The size in bytes of the function .zip file"
  value       = var.ignore_environment_variables ? element(concat(aws_lambda_function.ignore_environment_variables.*.source_code_size, [""]), 0) : element(concat(aws_lambda_function.default.*.source_code_size, [""]), 0)
}
